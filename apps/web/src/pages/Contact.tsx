          ...
          {isSubmitSuccessful ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2">
                    {["UX/UI", "Front-end", "Back-end", "Cloud/DevOps", "Sécurité", "Data/Analytics"].map((s) => (
                      <label key={s} className="flex items-center gap-2 text-sm text-slate-300 bg-white/5 ring-1 ring-white/10 rounded-lg px-3 py-2">
                        <input
                          type="checkbox"
                          value={s}
                          {...register("services")}
              ...
              <div>
                ...
                <input type="file" multiple className="field mt-1" {...register("files")} />
