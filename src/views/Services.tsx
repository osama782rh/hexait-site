...
const asset = (p: string) => p.startsWith('/') ? p : '/images/services/' + p;
    ...
    <>
        ...
        <div id="services-hero" className="container grid md:grid-cols-2 gap-8 items-center">
          <div className="reveal">
            ...
            <div className="hero-actions">
              <Link href="/contact" className="btn-cta">Cadrer mon projet</Link>
              <Link href="/projets" className="btn-ghost">Voir nos réalisations</Link>
            </div>
          </div>
        ...
        <div id="ux" className="container grid md:grid-cols-2 gap-8 items-start">
          <div className="reveal">
            <div className="flex items-center gap-3">
              <Palette className="text-[var(--accent-light)]" aria-hidden="true" />
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              {[
                ...
                <div key={i} className="card reveal hover:transform hover:-translate-y-1 transition-all duration-300">
                  <div className="text-[var(--accent-light)]">{b.icon}</div>
          ...
          <div className="space-y-4">
            <div className="card overflow-hidden reveal hover:transform hover:scale-[1.02] transition-all duration-300">
              ...
              <p className="text-sm text-[var(--text-tertiary)] mt-2">De l'idée au prototype testable</p>
            </div>
            <div className="card overflow-hidden reveal hover:transform hover:scale-[1.02] transition-all duration-300">
              <div className="aspect-video rounded-xl overflow-hidden ring-1 ring-white/10">
                <img
              ...
              <p className="text-sm text-[var(--text-tertiary)] mt-2">Design system cohérent et maintenable</p>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section>
        <div id="developpement" className="container">
          <div className="flex items-center gap-3">
            <Code className="text-[var(--accent-light)]" aria-hidden="true" />
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            {[
              ...
              <article key={c.title} className="card overflow-hidden reveal hover:transform hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="mt-4">
                  <div className="text-[var(--accent-light)]">{c.icon}</div>
      ...
      <Section>
        <div id="devops" className="container grid md:grid-cols-2 gap-8 items-start">
          <div className="reveal">
            <div className="flex items-center gap-3">
              <GitBranch className="text-[var(--accent-light)]" aria-hidden="true" />
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <div className="text-[var(--accent-light)]"><Cloud aria-hidden="true" /></div>
              ...
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <div className="text-[var(--accent-light)]"><Rocket aria-hidden="true" /></div>
      ...
      <Section>
        <div id="securite" className="container">
          ...
          <div className="card mt-6 p-6 reveal hover:bg-white/10 transition-colors">
            <p className="text-sm uppercase tracking-wider text-[var(--text-tertiary)]">Bonnes pratiques implémentées</p>
            <ul className="list-dash mt-2">
      ...
      <Section>
        <div id="data" className="container grid md:grid-cols-2 gap-8 items-start">
          <div className="reveal">
            <div className="flex items-center gap-3">
              <Brain className="text-[var(--accent-light)]" aria-hidden="true" />
            ...
            <div className="mt-4 flex gap-3">
              <Link href="/contact" className="btn-cta">Cadrer un projet data</Link>
              <Link href="/projets" className="btn-ghost">Voir un exemple</Link>
            </div>
          </div>
          <div className="card overflow-hidden reveal hover:transform hover:scale-[1.02] transition-all duration-300">
            <div className="aspect-video rounded-xl overflow-hidden ring-1 ring-white/10">
            ...
            <p className="text-sm text-[var(--text-tertiary)] mt-2">Tableaux de bord métier personnalisés</p>
          </div>
        </div>
      </Section>
      ...
      <Section>
        <div id="faq" className="container">
          <div className="flex items-center gap-3">
            <Workflow className="text-[var(--accent-light)]" aria-hidden="true" />
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-4">
            {[
              ...
              <details key={f.q} className="card p-4 reveal hover:bg-white/10 transition-colors">
                <summary className="font-semibold cursor-pointer hover:text-[var(--accent-light)] transition-colors">{f.q}</summary>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-6">
          {items.map((x) => (
            <article key={x.title} className="card reveal hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-[var(--text-tertiary)] text-sm">Durée : {x.duration}</p>
              <p className="text-[var(--text-secondary)] text-sm mt-2">Pour : {x.forWhom}</p>
              <p className="text-xs uppercase tracking-wider text-[var(--text-tertiary)] mt-3">Livrables</p>
              <ul className="list-dash mt-1">{x.deliverables.map(d => <li key={d}>{d}</li>)}</ul>
              <p className="text-[var(--text-secondary)] text-sm mt-3"><strong>Résultat :</strong> {x.outcome}</p>
              <div className="mt-4">
          ...
          {guarantees.map((g, i) => (
            <div key={i} className="card reveal hover:transform hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-start gap-3">
                {g.icon}
                <div>
                  <h3 className="font-bold text-[var(--text-primary)]">{g.title}</h3>
                  <p className="text-[var(--text-secondary)] text-sm mt-1">{g.desc}</p>
                </div>
              </div>
            </div>
          ))}
