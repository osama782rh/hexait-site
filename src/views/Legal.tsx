      ...
      >
        <div className="container text-center px-6">
          ...
          <p className="hero-sub mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Conformité RGPD &bull; Transparence &bull; Protection des données
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div>
                ...
                <div className="space-y-3 text-[var(--text-secondary)]">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+33765668282" className="hover:text-[var(--accent-light)] transition-colors">
                      +33 7 65 66 82 82
                    </a>
                  </div>
                </div>
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="text-[var(--text-secondary)] space-y-2">
                ...
                <p><strong>Site web :</strong> <a href="https://www.lws.fr" target="_blank" rel="noopener noreferrer" className="text-[var(--accent-light)] hover:text-[var(--accent-light)]">www.lws.fr</a></p>
                <p><strong>Email :</strong> <a href="mailto:support@lws.fr" className="text-[var(--accent-light)] hover:text-[var(--accent-light)]">support@lws.fr</a></p>
            </div>
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="text-[var(--text-secondary)] space-y-4">
              ...
              <p>
                ...
                <a href="mailto:contact@hexait.fr" className="text-[var(--accent-light)] hover:text-[var(--accent-light)] ml-1">
                  contact@hexait.fr
                </a>
              </p>
              <p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <Link href="/politique-confidentialite" className="btn-ghost">
              Politique de confidentialité
            </Link>
            <Link href="/conditions-generales" className="btn-ghost">
