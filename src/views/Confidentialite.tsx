        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="text-[var(--text-secondary)] space-y-2">
              ...
              <p>Email : <a href="mailto:contact@hexait.fr" className="text-[var(--accent-light)] hover:text-[var(--accent-light)]">contact@hexait.fr</a></p>
              <p>Téléphone : <a href="tel:+33765668282" className="text-[var(--accent-light)] hover:text-[var(--accent-light)]">+33 7 65 66 82 82</a></p>
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                <Eye className="text-[var(--accent)] mt-1 flex-shrink-0" size={20} />
                <div>
                  <h4 className="font-semibold mb-2">Droit d'accès</h4>
                  <p className="text-[var(--text-secondary)] text-sm">Obtenir une copie de vos données</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3">
                <Edit className="text-[var(--accent)] mt-1 flex-shrink-0" size={20} />
                <div>
                  <h4 className="font-semibold mb-2">Droit de rectification</h4>
                  <p className="text-[var(--text-secondary)] text-sm">Corriger des données inexactes</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3">
                <Trash2 className="text-[var(--accent)] mt-1 flex-shrink-0" size={20} />
                <div>
                  <h4 className="font-semibold mb-2">Droit à l'effacement</h4>
                  <p className="text-[var(--text-secondary)] text-sm">Supprimer vos données ("droit à l'oubli")</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3">
                <Database className="text-[var(--accent)] mt-1 flex-shrink-0" size={20} />
                <div>
                  <h4 className="font-semibold mb-2">Droit à la portabilité</h4>
                  <p className="text-[var(--text-secondary)] text-sm">Récupérer vos données dans un format structuré</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="text-[var(--text-secondary)] space-y-4">
              ...
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <p className="text-sm text-[var(--text-tertiary)]">Délégué à la Protection des Données</p>
                <a href="mailto:contact@hexait.fr" className="text-[var(--accent-light)] hover:text-[var(--accent-light)] text-sm">
                  contact@hexait.fr
                </a>
              </div>
              ...
              <p className="text-sm text-[var(--text-tertiary)]">
                ...
                vous pouvez saisir la <a href="https://www.cnil.fr" className="text-[var(--accent-light)] hover:text-[var(--accent-light)]">CNIL</a>.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <Link href="/cookies" className="btn-ghost">
              Gestion des cookies
            </Link>
