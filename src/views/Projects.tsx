      ...
      <Section>
        <div className="container text-center">
          ...
          <div className="hero-actions mt-6 reveal reveal-delay-2">
            <Link href="/contact" className="btn-cta">Lancer votre projet</Link>
        ...
        <div className="container text-center">
          <div className="card p-10 md:p-12 reveal hover:transform hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="mt-6 flex gap-4 justify-center flex-wrap">
              ...
              <Link href="/services" className="btn-ghost">Découvrir nos services</Link>
            </div>
          </div>
        </div>
      </Section>
          ...
          <div className="reveal">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <Zap className="text-[var(--accent-light)] mb-2" size={20} />
                <h4 className="font-bold text-sm">Génération IA</h4>
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Devis et factures automatiques</p>
              </div>
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <Cloud className="text-[var(--accent-light)] mb-2" size={20} />
                <h4 className="font-bold text-sm">Multi-métiers</h4>
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Artisans, freelances, PME</p>
              </div>
            </div>

            <div className="mt-6">
              <h4 className="font-bold text-[var(--text-primary)] mb-3">Stack technique</h4>
              <div className="flex flex-wrap gap-2">
                {["Next.js", "TypeScript", "PostgreSQL", "Stripe", "Azure"].map(tech => (
                  <span key={tech} className="px-3 py-1 bg-white/5 rounded-full text-sm text-[var(--text-secondary)]">
                    {tech}
                  </span>
                ))}
              </div>
            ...
            <div className="reveal">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-xs text-[var(--text-tertiary)] mt-1">QR code, commandes et paiements</p>
                </div>
                <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                  <Zap className="text-green-300 mb-2" size={20} />
                  <h4 className="font-bold text-sm">KDS & Analytics</h4>
                  <p className="text-xs text-[var(--text-tertiary)] mt-1">Écran cuisine et tableau de bord</p>
                </div>
              </div>
          ...
          <div className="reveal">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Audit concurrentiel et analyse des écarts</p>
              </div>
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <Workflow className="text-purple-300 mb-2" size={20} />
                <h4 className="font-bold text-sm">Espaces de travail collaboratifs</h4>
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Calendrier éditorial et permissions</p>
              </div>
            </div>
            ...
            <div className="mt-6">
              <h4 className="font-bold text-[var(--text-primary)] mb-3">Stack technique</h4>
              <div className="flex flex-wrap gap-2">
                {["Next.js", "TypeScript", "Python", "PostgreSQL", "Redis"].map(tech => (
                  <span key={tech} className="px-3 py-1 bg-white/5 rounded-full text-sm text-[var(--text-secondary)]">
                    {tech}
                  </span>
                ))}
          ...
          <div className="reveal">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-xs text-[var(--text-tertiary)] mt-1">Données unifiées</p>
              </div>
              <div className="card hover:transform hover:-translate-y-1 transition-all duration-300">
                <GitBranch className="text-purple-300 mb-2" size={20} />
                <h4 className="font-bold text-sm">Workflows Automatisés</h4>
                <p className="text-xs text-[var(--text-tertiary)] mt-1">n8n & intégrations</p>
              </div>
            </div>
  ...
  const projects = [
    {
      ...
      icon: <BarChart3 className="text-[var(--accent-light)]" size={20} />,
      status: "Privé",
  ...
  return (
    <Section>
      <div className="container">
        ...
        <p className="text-[var(--text-secondary)] text-center mt-2 reveal reveal-delay-1">
          ...
          {projects.map((project, index) => (
            <div key={index} className="card reveal hover:transform hover:-translate-y-2 transition-all duration-300">
              <div className="flex items-center gap-3">
                {project.icon}
                <span className="px-2 py-1 bg-white/5 rounded text-xs text-[var(--text-tertiary)]">
                  {project.status}
                </span>
              </div>
              <h3 className="font-bold mt-3">{project.title}</h3>
              <p className="text-[var(--text-secondary)] text-sm mt-2">{project.description}</p>
              <div className="mt-4 flex flex-wrap gap-2">
                {project.tags.map(tag => (
                  <span key={tag} className="px-2 py-1 bg-white/5 rounded text-xs text-[var(--text-tertiary)]">
                    {tag}
                  </span>
                ))}
              </div>
